...
{
    public class SampleData : DropCreateDatabaseIfModelChanges<EFCodeFirst1Entities>//使用db first当数据模型改变时重新创建数据库并播种（数据库原始数据）
    {
        protected override void Seed(EFCodeFirst1Entities context)
        {
